...
tEvent is a base Extra template that is useful when wanting to create a new
...
Then, navigate to the directory tEvent is now in, and do this:
...
Now, you'll want to change references to tEvent in the files in your
new copied-from-tEvent repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'tEvent' to whatever the
name of your component is.

## Copyright Information

tEvent is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of tEvent the ability to modify, distribute
and use tEvent in MODx development as they see fit, as long as attribution
